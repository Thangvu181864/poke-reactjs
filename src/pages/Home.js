...
const Home = () => {
  ...
  return (
    <>
      <h1 className="text-3xl font-bold underline pt-4">Pokemon</h1>
      <PokemonColection pokemons={pokemons} />
      <div className="block justify-center p-3">
        {loading ? (
          <svg
            role="status"
          ...
          <button className="p-2 bg-blue-400 rounded-md" onClick={getPokemon}>
            Load more
          </button>
        )}
      </div>
